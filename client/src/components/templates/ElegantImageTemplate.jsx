...
const ElegantImageTemplate = ({ data, accentColor, removeBackground }) => {
      ...
      <div className="grid grid-cols-3">
        ...
        <div className="col-span-1 py-10 flex justify-center">
          {data.personal_info?.image && (
            <img
              ...
              style={{ borderColor: accentColor, borderWidth: 3 }}
            />
          )}
        </div>
        ...
        <aside className="col-span-1 border-r border-zinc-400 p-6 pt-0">
          ...
          <section className="mb-8">
            <h2 className="text-sm tracking-widest text-zinc-600 font-semibold mb-3">
              CONTACT
            </h2>
...
export default ElegantImageTemplate;
