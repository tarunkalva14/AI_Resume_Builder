...
const SquarePhotoTemplate = ({ data, accentColor, removeBackground }) => {
        ...
        <div className="col-span-1 py-10">
          ...
          {data.personal_info?.image && (
            <img 
              ...
              alt="Profile" 
              className="mb-6 w-32 h-32 rounded-full mx-auto object-cover"
            />
          )}
        </div>
...
export default SquarePhotoTemplate;
