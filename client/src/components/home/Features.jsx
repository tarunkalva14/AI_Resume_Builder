...
const Features = () => {
    ...
    return (
        ...
        <div className="flex items-center gap-2 text-sm text-indigo-700 bg-indigo-300/10 rounded-full px-6 py-1.5">
            <Zap width={14}/>
            <span>Easy Process</span>
        </div>
        <Title title='Build Your Own Resume' descrption='Create a professional, job-ready resume in minutes using intelligent AI tools designed for today’s hiring process.'/>    
