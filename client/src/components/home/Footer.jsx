...
const Footer = () => {
    ...
    return(
        <>
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-black-600 bg-gradient-to-r from-indigo-500 via-indigo-200/50 to-white mt-40">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    <a
                        ...
                        <img src="/logo-black.svg" alt="logo" className="h-11 w-auto" />
                    </a>
                    <div>
                    ...
                    <div>
                        <p className="text-black-500 font-semibold">Resources</p>
                        <ul className="mt-2 space-y-2">
                    ...
                    <div>
                        <p className="text-black-500 font-semibold">Legal</p>
                        <ul className="mt-2 space-y-2">
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <p className="mt-3 text-center">© 2025 Build Resume </p>
                </div>
            </footer>
        <style>{`
