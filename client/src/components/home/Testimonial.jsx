...
const Testimonial = () =>{
    ...
    return (
        ...
        <div className="flex items-center gap-2 text-sm text-indigo-700 bg-indigo-400/10 rounded-full px-6 py-1.5">
            <BookUserIcon className="size-4.5 stroke-indigo-700"/>
            <span>Testimonials</span>
        </div>
        <Title title='Real Users.Real Success' descrption='Discover how professionals use our platform 
        to build better resumes and take the next step in their careers.'/>
        </div>
