        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Add summary for your own resume</p>
                </div>
                <button disabled={isGenerating} onClick={generateSummary} className="flex items-center gap-3 px-3 py-1 text-sm bg-purple-100
            ...
            <div className="mt-6">
                ...
                placeholder="Tell your story in one powerful sentence that highlights your strengths.."/>
                <p className="text-xs text-gray-500 max-w-4/5 mx-auto text-center">
                Tip:Aim for (3-4) short lines that highlight your skills, experience, and career goals.</p>
            </div>
        </div>
    )
}
