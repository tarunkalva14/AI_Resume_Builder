...
const getImageUrl = (imageUrl, removeBackground) => {
    if (!imageUrl || typeof imageUrl !== 'string') return imageUrl;
    
    if (removeBackground && imageUrl.includes('ik.imagekit.io')) {
        return imageUrl.replace('/tr:', '/tr:bg-transparent,');
    }
        ...
        <div>
            ...
            <div className="flex items-center gap-2">
                <label>
                    {data.image ? (
                        <div 
                            className="w-16 h-16 rounded-full overflow-hidden mt-5 ring ring-slate-300 hover:opacity-80 transition-all duration-200"
                            style={{
                                backgroundColor: removeBackground ? 'white' : accentColor
                            }}
                        >
                            <img 
                                src={getImageUrl(
                        ...
                        duration-200 cursor-pointer px-2 py-1 rounded-md">
                ...
                {data.image && (
                    <div className="flex flex-col gap-1 pl-4 text-sm">
                        ...
                        text-gray-900 gap-3">
                            ...
                            peer-checked:bg-indigo-700 transition-colors duration-200">
                            </div>
